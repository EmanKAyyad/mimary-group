...
if ( ! class_exists( 'Ultimate_VC_Addons' ) ) {
	...
	class Ultimate_VC_Addons {
		...
		function __construct() {
			...
			$this->ultimate_vc_addons_as_theme();
		...
		public function ultimate_vc_addons_as_theme() {
			if(defined('ULTIMATE_VC_ADDONS_THEME_ACTIVATED')) return;
			if(!defined('ULTIMATE_VC_ADDONS_THE7'))	define( 'ULTIMATE_VC_ADDONS_THE7', true);
			$theme_path = get_template_directory();
			$js_composer_bundled = "$theme_path/inc/mods/bundled-content/includes/ultimate-addon/ultimate-addon.class.php";
			if ( file_exists( $js_composer_bundled ) ) {
				...
				$bundled_plugin = new The7UltimateAddon();
				if ( $bundled_plugin->isActivatedByTheme() ) {
					define( 'ULTIMATE_VC_ADDONS_THEME_ACTIVATED', true );
				}
			}
		}
